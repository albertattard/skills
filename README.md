...
The repository currently provides nine skills:
...
- `create-oracle-java-dockerfile`: analyzes a Java project and creates an Oracle
  ...
  validation.
- `create-java-web-functional-test-harness`: creates a separate Java Maven
  functional-test project for a web application with Playwright, JUnit 5, and a
  simple Docker-backed application harness.
