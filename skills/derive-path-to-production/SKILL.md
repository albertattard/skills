...
9. Ask the user before writing files when the production target, operational owner, compliance posture, data handling, or release strategy materially changes the plan.
10. Write or update the production plan under `docs/production/`, and keep the directory `README.md` current when files are added, moved, or deleted.
